...
public class EitherTest extends AbstractValueTest {
    ...
    protected <T> Either<?, T> empty() {
        return Either.<T, T>left((T) "error");
    }
    ...
    public void shouldSequenceEmptyIterableOfEither() {
        final Iterable<Either<Integer, String>> eithers = new ArrayList<>();
        final Either<List<Integer>, List<String>> actual = Either.sequence(eithers);
        final Either<List<Integer>, List<String>> expected = Either.right(new ArrayList<>());
        assertThat(actual).isEqualTo(expected);
    }
    ...
    public void shouldSequenceNonEmptyIterableOfRight() {
        ...
        final Either<List<Integer>, List<String>> actual = Either.sequence(eithers);
        final Either<List<Integer>, List<String>> expected = Either.right(List.of("a", "b", "c"));
        assertThat(actual).isEqualTo(expected);
    }
    ...
    public void shouldSequenceNonEmptyIterableOfLeft() {
        ...
        final Either<List<Integer>, List<String>> actual = Either.sequence(eithers);
        final Either<List<Integer>, List<String>> expected = Either.left(List.of(1, 2, 3));
        assertThat(actual).isEqualTo(expected);
    }
    ...
    public void shouldSequenceNonEmptyIterableOfMixedEither() {
        ...
        final Either<List<Integer>, List<String>> actual = Either.sequence(eithers);
        final Either<List<Integer>, List<String>> expected = Either.left(List.of(1, 3));
        assertThat(actual).isEqualTo(expected);
    }
    ...
    public void shouldSequenceRightEmptyIterableOfEither() {
        final Iterable<Either<Integer, String>> eithers = new ArrayList<>();
        final Either<Integer, List<String>> actual = Either.sequenceRight(eithers);
        final Either<Integer, List<String>> expected = Either.right(new ArrayList<>());
        assertThat(actual).isEqualTo(expected);
    }
    ...
    public void shouldSequenceRightNonEmptyIterableOfRight() {
        final Iterable<Either<Integer, String>> eithers = List.of(Either.right("a"), Either.right("b"), Either.right("c"));
        final Either<Integer, List<String>> actual = Either.sequenceRight(eithers);
        final Either<Integer, List<String>> expected = Either.right(List.of("a", "b", "c"));
        assertThat(actual).isEqualTo(expected);
    }
    ...
    public void shouldSequenceRightNonEmptyIterableOfLeft() {
        final Iterable<Either<Integer, String>> eithers = List.of(Either.left(1), Either.left(2), Either.left(3));
        final Either<Integer, List<String>> actual = Either.sequenceRight(eithers);
        final Either<Integer, List<String>> expected = Either.left(1);
        assertThat(actual).isEqualTo(expected);
    }
